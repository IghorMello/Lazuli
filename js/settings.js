...
var restrictionList = [];
var notifyList = [];
var blockBtnList = ['settingsBtn', 'restrictionsBtn', 'notifyBtn', 'waterBtn', 'pomodoroBtn', 'aboutBtn'];
var blockList = ['settingsBlock', 'restrictionsBlock', 'notifyBlock', 'waterBlock', 'pomodoroBlock', 'aboutBlock'];
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('waterBtn').addEventListener('click', function () {
        setBlockEvent('waterBtn', 'waterBlock');
    });

    document.getElementById('pomodoroBtn').addEventListener('click', function () {
        setBlockEvent('pomodoroBtn', 'pomodoroBlock');
    });
...
function actionEditSite(e, actionUpdateTimeFromList, actionUpdateList) {
    ...
    if (timeElement.classList.contains('clock-li-readonly')) {
        ...
        editCmd.src = '/images/success.png';
        $('.clockpicker').clockpicker();
    }
    else {
