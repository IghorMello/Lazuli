...
add_lazuli_prefix_to_polymer_elements = (intervention_code, elements_to_replace) ->
  ...
  for x in elements_to_replace
    element_to_replacement[x] = 'lazuli-' + x
...
module.exports = {
  add_lazuli_prefix_to_polymer_elements: add_lazuli_prefix_to_polymer_elements,
