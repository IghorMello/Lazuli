...
class UI {
  ...
  setUIForToday() {
    ...
    document.getElementById("stretch").classList.add("hide");
  ...
  setUIForWater() {
    ...
    document.getElementById("btnToday").classList.remove("active");
    document.getElementById("btnByDays").classList.remove("active");
    document.getElementById("donutChartBtn").classList.remove("hide");
    document.getElementById("heatMapChartBtn").classList.remove("hide");
  ...
  setUIForStretch() {
    document.getElementById("btnStretch").classList.add("active");
    document.getElementById("btnWater").classList.remove("active");
    document.getElementById("btnPomodoro").classList.remove("active");
    document.getElementById("btnAll").classList.remove("active");
    document.getElementById("btnToday").classList.remove("active");
    ...
    document.getElementById("stretch").classList.remove("hide");
    document.getElementById("water").classList.add("hide");
    document.getElementById("chart").classList.add("hide");
    document.getElementById("pomodoro").classList.add("hide");
    document.getElementById("blockForChartBtn").classList.add("hide");
  ...
  setUIForPomodoro() {
    ...
    document.getElementById("water").classList.add("hide");
    document.getElementById("stretch").classList.add("hide");
    document.getElementById("pomodoro").classList.remove("hide");
    document.getElementById("labelForTimeInterval").classList.add("hide");
    this.clearUI();
  }
  ...
  createTotalBlock(totalTime, currentTypeOfList, counter) {
    ...
    var spanVisits = this.createElement(
      "span",
      ["span-visits", "tooltip", "visits"],
  ...
  fillEmptyBlockForDaysIfInvalid() {
    document.getElementById("tableForDaysBlock").innerHTML =
      '<p class="no-data">Dados inválidos</p>';
  }
  ...
  addLineToTableOfSite(
    ...
    else img.setAttribute("src", "/images/empty.png");
    ...
    if (tab.url.isMatch(currentTab)) {
      ...
      imgCurrentDomain.setAttribute("src", "/images/eye.png");
  ...
  addRestrictionIcon(tab, restrictions, spanUrl) {
    ...
    if (item !== undefined) {
      ...
      limitIcon.height = 15;
      limitIcon.src = "/images/limit.png";
