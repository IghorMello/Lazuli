class UserSettingsStorage {
    ...
    get settings() {
        ...
        const pomodorotime = this._getItem("pomodorotime");
        ...
        return pomodoros ? new UserSettings(pomodoros, pomodorotime, shortbreak, longbreak, soundEnabled) : this.settings = new UserSettings(4, "25:00", "05:00", "30:00", true);
    }

    set settings(userSettings) {
        this._setItem("pomodoros", userSettings.pomodoros);
        this._setItem("pomodorotime", userSettings.pomodorotime);
