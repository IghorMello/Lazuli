...
async function show_first_impression_notice_power() {
  require('components/lazuli-intervention-first-seen-power.deps')
  require('libs_frontend/frontend_libs').append_to_body_shadow(document.createElement('lazuli-intervention-first-seen-power'), { zIndex: 2147483647 })
}

async function show_first_impression_notice_info() {
  require('components/lazuli-intervention-first-seen-info.deps')
  require('libs_frontend/frontend_libs').append_to_body_shadow(document.createElement('lazuli-intervention-first-seen-info'), { zIndex: 2147483647 })
}
