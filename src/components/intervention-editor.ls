...
script.parentNode.removeChild(script);
  ...
  #     this.S('#sidebar').show()
  help_clicked: ->
    # chrome.tabs.create {url: 'https://lazuli.github.io/devdocs'}
    this.is_tutorial_shown=true
    this.selected_tab_idx=0
  share_clicked: ->>
    if localStorage.show_market != 'true'
      chrome.tabs.create {url: 'https://github.com/lazuli/lazuli/wiki/Share-Interventions'}
      return
  ...
  make_public_share: ->>
    ...
    chrome.identity.getProfileUserInfo (author_info) ->>
        ...
        if upload_result.status=='success'
            ...
            swal("Falha ao carregar cutucar, por favor, abra um tíquete!")
