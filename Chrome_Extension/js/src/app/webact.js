...
var stat = {
  ...
  set inActiveDayWithoutCurrentDay(value) {
    document.getElementById("statInActiveDayWithoutCurrentDay").innerHTML =
      value;
  ...
  set inActiveDayTime(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statInActiveDayTime")
    );
  ...
  set inActiveDayTimeWithoutCurrentDay(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statInActiveDayTimeWithoutCurrentDay")
    );
  ...
  set averageTime(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statAverageTime")
    );
  },
  set activeDayTime(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statActiveDayTime")
    );
  },
  set activeDayTimeWithoutCurrentDay(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statActiveDayTimeWithoutCurrentDay")
    );
  },
  set todayTime(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.ToDay,
      document.getElementById("statTodayTime")
    );
  },
  set allDaysTime(value) {
    ...
    ui.createElementsForTotalTime(
      value,
      TypeListEnum.All,
      document.getElementById("statAllDaysTime")
    );
  },
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("donutChartBtn")
    .addEventListener("click", function () {
      ui.setUIForDonutChart();
      getDataFromStorage();
    });
  document
    .getElementById("heatMapChartBtn")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("statInActiveDayIcon")
    .addEventListener("click", function () {
      fillBlockWithInActiveDay();
    });
  document
    .getElementById("statActiveDayIcon")
    .addEventListener("click", function () {
      fillBlockWithActiveDay();
    });
  document
    .getElementById("closeHintBtn")
    .addEventListener("click", function () {
...
function getLimitsListFromStorageCallback(items) {
  restrictionList = (items || []).map(
    (item) => new Restriction(item.url, item.time)
  );
}
...
function getTabsFromStorage(tabs) {
  ...
  for (var i = 0; i < tabGroups.length; i++) {
    ...
    const targetTab =
      tabGroup.tabs.find((t) => t.url.isMatch(currentTab)) || tabGroup.tabs[0];
  ...
  switch (typeOfList) {
    ...
    case TypeListEnum.ToDay:
      ...
      var summaryTimeList = tabs.map(function (a) {
        return a.days.find((s) => s.date === date).summary;
      });
...
function fillBlockWithActiveDay() {
  ...
  if (flag == "true")
    fillValuesForBlockWithInActiveDay(
      "statActiveDay",
      stat.activeDayWithoutCurrentDay,
      stat.activeDayTimeWithoutCurrentDay,
      flag
    );
  else
...
function fillValuesForBlockWithInActiveDay(prefix, dayValue, timeValue, flag) {
  if (flag == "true") {
    ...
    document.getElementById(prefix + "Title").innerHTML =
      "Incluir o dia atual no cálculo das estatísticas";
    document.getElementById(prefix + "Icon").dataset.today = false;
    document.getElementById(prefix + "Icon").src = "/assets/img/no-today.svg";
    ...
    document.getElementById(prefix + "Title").innerHTML =
      "Não inclua o dia atual no cálculo das estatísticas”";
    document.getElementById(prefix + "Icon").dataset.today = true;
    document.getElementById(prefix + "Icon").src = "/assets/img/today.svg";
